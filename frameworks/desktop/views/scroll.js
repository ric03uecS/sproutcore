...
/** @scope SC.ScrollView.prototype */
  ...
  */
  contentViewFrameDidChange: function () {
    ...
    this._scroll_minimumHorizontalScrollOffset = this._scsv_minimumScrollOffset(width, containerWidth, hAlign);
    this._scroll_maximumHorizontalScrollOffset = this._scsv_maximumScrollOffset(width, containerWidth, hAlign);
    this._scroll_minimumVerticalScrollOffset = this._scsv_minimumScrollOffset(height, containerHeight, vAlign);
    this._scroll_maximumVerticalScrollOffset = this._scsv_maximumScrollOffset(height, containerHeight, vAlign);

    // Update the scroller numbers...
    this._scsv_updateScrollers();

    // If that messed with our scrollability we have to re-update our mins and maxes.
    if (this.get('canScrollHorizontal') !== canScrollHorizontal) {
      canScrollHorizontal = this.get('canScrollHorizontal');
    ...
    if (this.get('canScrollVertical') !== canScrollVertical) {
      canScrollVertical = this.get('canScrollVertical');
